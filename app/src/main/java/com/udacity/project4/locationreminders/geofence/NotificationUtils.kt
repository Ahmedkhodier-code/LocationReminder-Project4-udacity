...
//        .setContentText(context.getString(R.string.content_text, context.getString(GeofencingConstants.LANDMARK_DATA!!.get(foundIndex).title)))
        .setContentText("great you are arrived")
